...
from src.schemas.holding import AccountHoldingsResponse, AddHoldingApiRequest, PortfolioHoldingDto
...
class HoldingService:
    ...
    async def get_holdings_by_account_and_date_async(
        ...
        holdings_result = await self.db.execute(
            ...
            .outerjoin(Platform, Holding.platform_id == Platform.id)
            .where(
        ...
        return [
            {
                ...
                'platform_name': row[8] or '',
                'ticker': row[1],
                'instrument_name': row[2],
                'unit_amount': holding.unit_amount,
                ...
                'daily_profit_loss': holding.daily_profit_loss,
                'daily_profit_loss_percentage': holding.daily_profit_loss_percentage,
            ...
            for row in holdings_rows:
                ...
                if ticker in prices:
                    ...
                    holdings_with_details.append({
                        ...
                        'gain_loss': new_current_value - holding.bought_value,
                        ...
                        'daily_profit_loss': daily_change,
                        'daily_profit_loss_percentage': daily_change_percentage,
